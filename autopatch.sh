...
top_dir=`pwd`
utils_dir="$top_dir/vendor/x86"
patch_dir="$utils_dir/android_q/google_diff/x86"
private_utils_dir="$top_dir/vendor/x86/PRIVATE"
private_patch_dir="$private_utils_dir/android_q/google_diff/$TARGET_PRODUCT"
